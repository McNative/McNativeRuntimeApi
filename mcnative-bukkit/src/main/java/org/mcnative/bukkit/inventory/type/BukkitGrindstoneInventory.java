...
import org.mcnative.service.inventory.type.GrindstoneInventory;

public class BukkitGrindstoneInventory extends BukkitInventory<org.bukkit.inventory.GrindstoneInventory> implements GrindstoneInventory {

    public BukkitGrindstoneInventory(InventoryOwner owner, org.bukkit.inventory.GrindstoneInventory original) {
        super(owner, original);
    }

    @Override
    public ItemStack getInputAbove() {
        return new BukkitItemStack(this.original.getItem(0));
    }

    @Override
    public void setInputAbove(ItemStack item) {
    ...
    @Override
    public void setInputBelow(ItemStack item) {
    ...
    public void setOutput(ItemStack item) {
        this.original.setItem(2, ((BukkitItemStack)item).getOriginal());
    }
