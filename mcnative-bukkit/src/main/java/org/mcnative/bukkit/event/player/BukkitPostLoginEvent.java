...
public class BukkitPostLoginEvent implements MinecraftPlayerPostLoginEvent {

    private final OnlineMinecraftPlayer player;

    public BukkitPostLoginEvent(OnlineMinecraftPlayer player) {
        this.player = player;
    }
