...
public class MinecraftPlayerDesignSetEvent implements MinecraftPlayerEvent, Cancellable {

    private final MinecraftPlayer player;
    private PlayerDesign design;
    private boolean cancelled;

    public MinecraftPlayerDesignSetEvent(MinecraftPlayer player, PlayerDesign design) {
        this.player = player;
        this.design = design;
