...
public class MinecraftPlayerDesignRequestEvent implements MinecraftPlayerEvent {

    private final MinecraftPlayer player;
    private PlayerDesign design;

    public MinecraftPlayerDesignRequestEvent(MinecraftPlayer player, PlayerDesign design) {
        this.player = player;
        this.design = design;
    }
