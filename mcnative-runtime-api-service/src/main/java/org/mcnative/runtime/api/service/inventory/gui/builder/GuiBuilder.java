...
public interface GuiBuilder<C extends GuiContext> {
    ...
    Screen<C, ScreenContext<C>> createScreen(String name, int size, Function<ScreenContext<C>, String> titleCreator, Consumer<ElementList<C, ScreenContext<C>>> elements);

    <P extends ScreenContext<C>> Screen<C,P> createScreen(String name, int size, Class<P> contextClass, Function<P, String> titleCreator, Consumer<ElementList<C,P>> elements);
