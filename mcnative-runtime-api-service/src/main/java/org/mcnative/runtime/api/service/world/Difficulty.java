...
public class Difficulty {
    ...
    private static final Collection<Difficulty> DIFFICULTIES = new ArrayList<>();

    private static final Difficulty PEACEFUL = createDefault("Peaceful",0);
    private static final Difficulty EASY = createDefault("Easy",1);
    private static final Difficulty NORMAL = createDefault("Normal",2);
    private static final Difficulty HARD = createDefault("Hard",3);
