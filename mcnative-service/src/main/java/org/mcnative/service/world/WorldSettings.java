...
public interface WorldSettings {
    ...
    Collection<String> getGameRoles();

    boolean hasGameRole(String role);

    String getGameRole(String role);

    int getGameRoleAmount(String role);

    boolean isGameRoleEnable(String role);

    void setGameRole(String role, Object value);
